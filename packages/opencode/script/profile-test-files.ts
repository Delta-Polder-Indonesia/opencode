// Per-file profiler for finding candidate test-speed work; see
// ../../specs/perf/test-suite.md for the contract and ../../perf/test-suite.md
// for benchmark notes, kept wins, and discarded experiments.
