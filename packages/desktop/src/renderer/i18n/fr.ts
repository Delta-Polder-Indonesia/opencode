export const dict = {
  ...
  "desktop.updater.none.title": "Aucune mise à jour",
  ...
  "desktop.error.dev.rootNotFound":
    "Élément racine introuvable. Avez-vous oublié de l'ajouter à votre index.html ? Ou l'attribut id est-il mal orthographié ?",
}
