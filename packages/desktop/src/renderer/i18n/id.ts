export const dict = {
  ...
  "desktop.updater.checkFailed.title": "Gagal memeriksa pembaruan",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan memulai ulang aplikasi?",
