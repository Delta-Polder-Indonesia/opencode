...
function useEnvProxy() {
  try {
    // Electron bundles Node 22+ which exposes this on the http module.
...
const main = Effect.gen(function* () {
  ...
  // The desktop renderer is a separate app entrypoint; the sidecar should
  // expose only the API, not the embedded web UI.
